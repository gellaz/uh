...
import { navbarItems } from '@/constast/navBarItems'
...
export default function NavBar() {
    ...
    const linkStyleActive = linkBase + ' font-medium bg-slate-200 hover:bg-slate-300'
        ...
        <nav className='flex flex-col bg-white shadow-sm'>
            <div className='flex flex-row items-center justify-between p-4 bg-white shadow-sm'>
                ...
                <Avatar className='w-10 h-10 rounded-full border border-black overflow-hidden'>
                    <AvatarFallback className='flex h-full text-black font-medium items-center justify-center'>{'FL'}</AvatarFallback>
                </Avatar>
            </div>
        </nav >
    )
