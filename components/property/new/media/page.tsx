...
export default function MediaPage() {
    ...
    const media = sharedContext.category != null ? propertyCategoryTypeItems[sharedContext.category]?.media : null
        ...
        < div className='w-full h-full flex flex-col space-y-10'>
            ...
            <div className='flex flex-col space-y-1'>
                ...
                <div className='grid grid-cols-4 gap-2 overflow-scroll'>
                    {
                        Array.from(
                            { length: 4 }, (_, index) => <UploadMediaDiv key={index} type={1} index={index} />
