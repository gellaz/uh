...
import { Trees, ParkingSquare, Flame } from 'lucide-react';
...
export default function FeaturesContent(features: Features) {
    ...
    const iconSize = 20
    const icons = [<Trees key={1} size={iconSize} color="white" />, <Trees key={2} size={iconSize} />, <ParkingSquare key={3} size={iconSize} />, <Flame key={4} size={iconSize} color={'white'} />]
