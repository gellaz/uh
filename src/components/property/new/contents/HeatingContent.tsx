...
export default function HeatingPage() {
  const types = [
    ...
    "Riscaldamento a pannelli radianti a ventilconvettori",
    "Riscaldamento a pannelli radianti a termosifoni",
    "Riscaldamento a pannelli radianti a stufa",
    "Riscaldamento a pannelli radianti a pellet",
    "Riscaldamento a pannelli radianti a legna",
    "Riscaldamento a pannelli radianti a carbone",
    "Riscaldamento a pannelli radianti a biomassa",
    "Riscaldamento a pannelli radianti a aria",
    "Riscaldamento a pannelli radianti a infrarossi",
    "Riscaldamento a pannelli radianti a pannelli radianti",
  ];
