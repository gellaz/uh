    ...
    switch (currentStepIndex) {
      case 0:
        ...
        return <div className="grid grid-cols-4 gap-4">
          {
            Object.values(propertyResidentialSubcategoryEnum.Values).map((subcategory) => (
              <div key={subcategory} className="row w-full space-x-4 items-center p-2 border rounded-md">
                {/* <input
                  type="radio"
                  name="subcategory"
                  value={subcategory}
...
=======
    <div className="col h-full w-full border rounded-2xl bg-purple-100">
      <Form {...form}>
        {/* HEADER */}
        <div className="px-4 pt-4">
          <h6 className="font-semibold text-md text-pretty">
            {currentStep.title}
          </h6>
        ...
        <form
          ...
          className="flex p-4 space-y-8 h-full w-full bg-green-100"
        >
          {getFormContent()}
        </form>
      </Form>
>>>>>>> Stashed changes
      ...
      {/* BOTTOM CONTENT*/}
      <div className="row mt-auto p-4 w-full h-fit space-x-4 bg-blue-100">
        <Button variant={"ghost"} onClick={prevStep} className="w-full">Back</Button>
        <Button type="button" onClick={nextStep} className="w-full">{currentStepIndex === totalSteps - 1 ? "Create" : "Next"}</Button>
      </div>
...
//               </FormControl>
//               <SelectContent>
//                 {["None", "Independent", "Centralized"].map(
//                   (item) => (
//                     <SelectItem value={item}>{item}</SelectItem>
//                   )
//                 )}
